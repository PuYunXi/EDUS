        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
                ...
                new MenuItemDefinition(PageNames.App.Common.Administration, L("Administration"), "fa fa-hourglass")
                    ...
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            requiredPermissionName: PermissionNames.Pages_Administration_MachineShiftSetting))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            //        requiredPermissionName: PermissionNames.Pages_Administration_WeChatNotifications))
                            //.AddItem(
                            // new MenuItemDefinition(
                            ...
                            //     url: "Maintain",
                            //     icon: "fa fa-upload",
                            //     requiredPermissionName: PermissionNames.Pages_Administration_Maintain))
            ...
            menu.AddItem(
                new MenuItemDefinition(
                    ...
                    url: "BasicData",
                    icon: "fa fa-files-o",
                    requiredPermissionName: PermissionNames.Pages_BasicData).AddItem(
                        new MenuItemDefinition(
                            PageNames.App.Page.BasicData_DeviceGroup,
                            L("DeviceGroups"),
                            url: "DeviceGroups",
                            icon: "fa fa-object-group",
                            requiredPermissionName: PermissionNames.Pages_BasicData_DeviceGroups))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "MachineType",
                            icon: "fa fa-tags",
                            requiredPermissionName: PermissionNames.Pages_BasicData_MachineType))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "MachineSetting",
                            icon: "fa fa-desktop",
                            requiredPermissionName: PermissionNames.Pages_BasicData_MachineSetting))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            requiredPermissionName: PermissionNames.Pages_BasicData_GatherParamsSetting))
                    //.AddItem(
                    //    new MenuItemDefinition(
                    ...
                    //        url: "ShiftSetting",
                    //        icon: "fa fa-list-ul",
                    //        requiredPermissionName: PermissionNames.Pages_BasicData_ShiftSetting))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "StateInfo",
                            icon: "fa fa-eraser",
                            requiredPermissionName: PermissionNames.Pages_BasicData_StateInfo))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "Product",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_Product))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            requiredPermissionName: PermissionNames.Pages_BasicData_AlarmInfo))
                    //.AddItem(
                    //    new MenuItemDefinition(
                    ...
                    //        requiredPermissionName: PermissionNames.Pages_BasicData_ShiftTargetYiled))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "ImportData",
                            icon: "fa fa-upload",
                            requiredPermissionName: PermissionNames.Pages_BasicData_ImportData))
            ...
            menu.AddItem(
                new MenuItemDefinition(
                    ...
                    icon: "fa fa-trello",
                    requiredPermissionName: PermissionNames.Pages_DevicesMonitoring).AddItem(
                        new MenuItemDefinition(
                            ...
                            requiredPermissionName: PermissionNames.Pages_DevicesMonitoring_States))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_DevicesMonitoring_Parameters))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            customData: new { IsDefaultShortcut = true },
                            requiredPermissionName: PermissionNames.Pages_DevicesRealtimeAlarms)));
            ...
            menu.AddItem(
                new MenuItemDefinition(
                        ...
                        icon: "fa fa-percent",
                        requiredPermissionName: PermissionNames.Pages_StatisticAnalysis)
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "AlarmStatistics",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_AlarmStatistics))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_HistoryParameters))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_EfficiencyTrends))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "TimeStatistics",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_TimeStatistics))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "YieldStatistics",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_YieldStatistics))
                     .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_QualifyStatistics))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_YieldAnalysisStatistics))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "OEE",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_OEE))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_StatusDistributionMap))
                );
                ...
                new MenuItemDefinition(
                    ...
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "Process",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_Process))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "StandardTime",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_StandardTime))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "Craft",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_Craft))
                    ...
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "MachineProcess",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_MachineProcess))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "ProductionPlan",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_ProductionPlan))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "LoginReport",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_LoginReport))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_DefectiveStatistics))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "MachineReport",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_MachineReport)));
            ...
            new MenuItemDefinition(
                ...
                url: "Plans",
                icon: "fa fa-calendar-check-o",
                requiredPermissionName: PermissionNames.Pages_Plan_Manage));
            ...
            //    url: "Plan",
            //    icon: "fa fa-circle-o",
            //    requiredPermissionName: PermissionNames.Pages_Plan)
            //        .AddItem(
            //            new MenuItemDefinition(
            //                PageNames.App.Page.ProducePlan_Plans,
            //                L("Plan"),
            ...
            menu.AddItem(
                new MenuItemDefinition(
                    ...
                    requiredPermissionName: PermissionNames.Pages_StaffPerformance).AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_StaffPerformance_OnlineOrOffline))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_StaffPerformance_OnlineOrOfflineRecord))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_StaffPerformance_StaffPerformance))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_StaffPerformance_StaffYield)));
            ...
            menu.AddItem(
                new MenuItemDefinition(
                    ...
                    requiredPermissionName: PermissionNames.Pages_Visual).AddItem(
                        new MenuItemDefinition(
                            ...
                            customData: new { IsDefaultShortcut = true },
                            requiredPermissionName: PermissionNames.Pages_VisualView))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            requiredPermissionName: PermissionNames.Pages_VisualNotice)));
            ...
            menu.AddItem(
                new MenuItemDefinition(
                    ...
                    requiredPermissionName: PermissionNames.Pages_Cutter).AddItem(
                        new MenuItemDefinition(
                            PageNames.App.Page.Cutter_CutterParameter,
                            L("CutterParameter"),
                            url: "CutterParameter",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Cutter_CutterParameter))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "CutterType",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Cutter_CutterType))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "CutterState",
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Cutter_CutterState))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Cutter_CutterLoadAndUnloadRecord)));
            ...
            menu.AddItem(
                new MenuItemDefinition(
                    ...
                    url: "Traceability",
                    icon: "fa fa-globe",
                    requiredPermissionName: PermissionNames.Pages_Traceability).AddItem(
                    new MenuItemDefinition(
                        PageNames.App.Page.Traceability_Catalog_Query,
                        L("TraceCatalogQuery"),
                        url: "Traceability",
                        icon: "fa fa-history",
                        requiredPermissionName: PermissionNames.Pages_Traceability_CatalogQuery))
                    ...
                    new MenuItemDefinition(
                        ...
                        icon: "fa fa-history",
                        requiredPermissionName: PermissionNames.Pages_Traceability_NgParts))
                    .AddItem(
                    new MenuItemDefinition(
                        ...
                        icon: "fa fa-history",
                        requiredPermissionName: PermissionNames.Pages_Traceability_Settings))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-circle-o",
                            requiredPermissionName: PermissionNames.Pages_Order_DefectiveReasons))
                        );
            ...
            menu.AddItem(
                new MenuItemDefinition(
                    ...
                    requiredPermissionName: PermissionNames.Pages_Notification).AddItem(
                    new MenuItemDefinition(
                        PageNames.App.Page.Notification_Rules,
                        L("NotificationRules"),
                        url: "NotificationRules",
                        icon: "fa fa-circle-o",
                        requiredPermissionName: PermissionNames.Pages_Notification_Rules)).AddItem(
                    new MenuItemDefinition(
                        PageNames.App.Page.Notification_Records,
                        L("NotificationRecords"),
                        url: "NotificationRecords",
                        icon: "fa fa-circle-o",
                        requiredPermissionName: PermissionNames.Pages_Notification_Records)));
            ...
            menu.AddItem(
                new MenuItemDefinition(
                        ...
                        url: "Feedback",
                        icon: "fa fa-reply",
                        requiredPermissionName: PermissionNames.Pages_ReasonFeedback)
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "ReasonFeedback",
                            icon: "fa fa-cogs",
                            requiredPermissionName: PermissionNames.Pages_ReasonFeedback_Feedback))
                   ...
                   .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-bar-chart",
                            requiredPermissionName: PermissionNames.Pages_ReasonFeedback_Analysis))
                );
            ...
            menu.AddItem(
               new MenuItemDefinition(
                       ...
                       requiredPermissionName: PermissionNames.Pages_RDLCReport)
                   .AddItem(
                       new MenuItemDefinition(
                           ...
                           icon: "fa fa-cogs",
                           requiredPermissionName: PermissionNames.Pages_RDLCReport_StateConsumeTime))
                    ...
                    .AddItem(
                       new MenuItemDefinition(
                           ...
                           icon: "fa fa-cogs",
                           requiredPermissionName: PermissionNames.Pages_RDLCReport_MachineUtilizationRate))
                     .AddItem(
                       new MenuItemDefinition(
                           ...
                           icon: "fa fa-cogs",
                           requiredPermissionName: PermissionNames.Pages_RDLCReport_PersonYield))
                     .AddItem(
                       new MenuItemDefinition(
                           ...
                           icon: "fa fa-cogs",
                           requiredPermissionName: PermissionNames.Pages_RDLCReport_PersonPerformance))
                     .AddItem(
                       new MenuItemDefinition(
                           ...
                           icon: "fa fa-cogs",
                           requiredPermissionName: PermissionNames.Pages_RDLCReport_Plan))
            ...
            menu.AddItem(
                new MenuItemDefinition(
                        ...
                        url: "Maintain",
                        icon: "fa fa-cubes",
                        requiredPermissionName: PermissionNames.Pages_Maintain)
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "MaintainPlan",
                            icon: "fa fa-cogs",
                            requiredPermissionName: PermissionNames.Pages_Maintain_Plan))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "MaintainOrder",
                            icon: "fa fa-cogs",
                            requiredPermissionName: PermissionNames.Pages_Maintain_Order))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "MaintainRequest",
                            icon: "fa fa-cogs",
                            requiredPermissionName: PermissionNames.Pages_Maintain_Request))
                    .AddItem(
                        new MenuItemDefinition(
                            ...
                            url: "MaintainRepair",
                            icon: "fa fa-cogs",
                            requiredPermissionName: PermissionNames.Pages_Maintain_Repair))
            );
            #endregion
           ...
           new MenuItemDefinition(
                  ...
                  L("Language"),
                   url: "MultiLanguage",
                   icon: "fa fa-language",
                   requiredPermissionName: PermissionNames.Pages_MultiLanguage)
            ...
            new MenuItemDefinition(
                       ...
                       url: "Carton",
                       icon: "fa fa-inbox",
                       requiredPermissionName: PermissionNames.Pages_Carton)
                .AddItem(
                    new MenuItemDefinition(
                        ...
                        url: "CartonRules",
                        icon: "fa fa-cogs",
                        requiredPermissionName: PermissionNames.Pages_Carton_CartonRules))
            .AddItem(
                       new MenuItemDefinition(
                           ...
                           url: "CartonSetting",
                           icon: "fa fa-cogs",
                           requiredPermissionName: PermissionNames.Pages_Carton_CartonSetting))
            .AddItem(
                       new MenuItemDefinition(
                           ...
                           url: "CartonPrinting",
                           icon: "fa fa-suitcase",
                           requiredPermissionName: PermissionNames.Pages_Carton_CartonPrinting))
            .AddItem(
                        new MenuItemDefinition(
                            ...
                            icon: "fa fa-globe",
                            requiredPermissionName: PermissionNames.Pages_Carton_CartonTraceability))
            );
